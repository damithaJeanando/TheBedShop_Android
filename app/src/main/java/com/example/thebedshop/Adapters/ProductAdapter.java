...
import com.example.thebedshop.Activities.ProductDetailsActivity;
...
//                    Toast.makeText(v.getContext(), prod_name.getText(), Toast.LENGTH_SHORT).show();
    ...
    public void onBindViewHolder(ProductViewHolder holder, int position) {
        ...
        holder.prod_price.setText("Rs. " + Double.toString(product.getPrice()));
        Glide.with(context).load(product.getImage()).apply(new RequestOptions().override(500,500)).centerCrop().into(holder.img_prod_card_img);
